...
def showLST(mapObject, state): 
    ...
    lst_mean = gmap.image_stats(image, aoi, scale=30).getInfo()['mean']['LST'] 
    lst_min = gmap.image_stats(image, aoi, scale=30).getInfo()['min']['LST']
    lst_std = gmap.image_stats(image, aoi, scale=30).getInfo()['std']['LST']
